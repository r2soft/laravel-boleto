...
class Brb extends AbstractBoleto implements BoletoContract
{
     ...
     * @var string
     */
    protected $codigoBanco = self::COD_BANCO_BRB;
    /**
     * Define as carteiras disponíveis para este banco
     *
     * @var array
     */
    protected $carteiras = ['COB'];

    protected $especiesCodigo400 = [
        'DM' => '21', //Duplicata Mercantil
        'DS' => '22', //Duplicata de Prestação de Serviço
        'NP' => '25', //Nota Promissória
        'CC' => '31', //Cartão
        'PT' => '32', //Proposta
        'DV' => '39', //Diversas e Outras
